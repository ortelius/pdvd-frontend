...
export default function AuthProfile({ isExpanded }: { isExpanded: boolean }) {
  ...
  if (isLoading) {
    return (
      <div className="p-4 border-t border-gray-200 dark:border-[#30363d] mt-auto flex justify-center">
  ...
  if (user) {
    return (
      <div className="p-4 border-t border-gray-200 dark:border-[#30363d] mt-auto bg-gray-50 dark:bg-[#161b22]">
  ...
  if (!isExpanded) {
    return (
      <div className="p-4 border-t border-gray-200 dark:border-[#30363d] mt-auto flex flex-col items-center gap-4">
        <button 
  ...
  return (
    <div className="p-4 border-t border-gray-200 dark:border-[#30363d] mt-auto">
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          <input
            ...
            className="w-full px-2 py-1.5 text-xs border border-gray-300 dark:border-[#30363d] rounded focus:border-blue-500 dark:focus:border-[#58a6ff] focus:ring-1 focus:ring-blue-500 dark:focus:ring-[#58a6ff] outline-none bg-white dark:bg-[#0d1117] text-gray-900 dark:text-[#e6edf3] placeholder:text-gray-400 dark:placeholder:text-[#7d8590]"
            required
          />
        </div>
        <div>
